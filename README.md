<!-- HEADER -->
<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=6A5ACD&height=120&section=header&text=Ane+Isabel+Negreiros&fontSize=31&fontColor=fff&animation=twinkling&fontAlignY=35"/>

<!-- TRANSITION MESSAGE -->
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=9370DB&size=30&center=true&vCenter=true&width=1000&lines=Olá,+sou+a+Ane!;Sou+apaixonada+por+Tecnologia.;Acredito+que+tecnologia+sem+gente+não+resolve+nada!)](https://git.io/typing-svg)

<a href="https://www.linkedin.com/anefreitas
" target="_blank">
    <img 
        alt="LinkedIn" 
...
Transformo interações digitais em experiências humanas e agora estou mergulhando no mundo dos **dados e da IA** para criar soluções ainda mais inteligentes.

📚 **Sempre estudando:** Python, SQL, Machine Learning e fundamentos de IA  
🎯 **Diferencial:** Visão sistêmica + empatia + tecnologia orientada por dados
...
### 📚 Bibliotecas Python que estou explorando
